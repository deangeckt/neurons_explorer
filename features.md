...
- Neuroglancer link — generate a link with src in orange, dst in blue
  (port `neuroglancer_utils.py::generate_neuroglancer_link` to TypeScript;
   needs the MICrONS Neuroglancer source URL)
